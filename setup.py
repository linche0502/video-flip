...
# os.system(fr'{scripts_path} {target} --onefile -w --noconsole --clean --distpath={output} --workpath=.\build --add-binary "static\ffmpeg\ffmpeg.exe;static\ffmpeg" --add-binary "static\ffmpeg\ffprobe.exe;static\ffmpeg"')
